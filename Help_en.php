...
<p>
	When adding a function to the equation, you will notice a Search screen popping up: the dropdown lists will allow you to filter the results of the function.  You can add a filter by clicking on the plus icon (+). Please note that a filter cannot be repeated for the same function. Each search screen corresponds to a function. If your equation contains more than one function, a new search screen will pop up.
</p>
<p>
